...
public class PipelineInstanceManagerTest {
    ...
    private ModuleName startNodeName, endNodeName;
    ...
    public void setup() {
        ...
        startNodeName = Mockito.mock(ModuleName.class);
        Mockito.when(startNode.getModuleName()).thenReturn(startNodeName);
        Mockito.when(startNodeName.getName()).thenReturn(START_NODE_NAME);

        endNode = Mockito.mock(PipelineDefinitionNode.class);
        endNodeName = Mockito.mock(ModuleName.class);
        Mockito.when(endNode.getModuleName()).thenReturn(endNodeName);
        Mockito.when(endNodeName.getName()).thenReturn(END_NODE_NAME);
    ...
    public void testInitialize() {
        ...
        WorkerFireTriggerRequest wftr = new WorkerFireTriggerRequest(PIPELINE_NAME, INSTANCE_NAME,
        ...
        wftr = new WorkerFireTriggerRequest(PIPELINE_NAME, INSTANCE_NAME, startNode, endNode, -1,
            100);
        pipelineInstanceManager.initialize(wftr);
    ...
    public void testFireTriggerOnceAndSucceed() {
        ...
        Mockito.verify(pipelineOperations, Mockito.times(1))
            .fireTrigger(pipelineDefinition, INSTANCE_NAME, startNode, endNode);
        Mockito.verify(pipelineOperations, Mockito.times(1)).sendWorkerMessageForTask(task0);
    }
    ...
    public void testFireTriggerMultipleTimesAndSucceed() {
        ...
        Mockito
            ...
            .thenReturn(new InstanceAndTasks(instance3, taskList));
    ...
    public void testIntervals() {
        ...
        wftr = new WorkerFireTriggerRequest(PIPELINE_NAME, INSTANCE_NAME, startNode, endNode, 4,
            60);
        pipelineInstanceManager.initialize(wftr);
        ...
        // equal to 1 second
        wftr = new WorkerFireTriggerRequest(PIPELINE_NAME, INSTANCE_NAME, startNode, endNode, 4, 0);
        pipelineInstanceManager.initialize(wftr);
