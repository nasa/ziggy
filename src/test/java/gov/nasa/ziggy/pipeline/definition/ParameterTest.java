...
/**
 * Unit test class for {@link Parameter} class.
 *
 * @author PT
 */
public class ParameterTest {
    ...
    public void testConstructor() {
        ...
        Parameter t = new Parameter("dummy", "100.", "dOuBlE");
        ...
        t = new Parameter("dummy", "100.", "doublearray");
        assertEquals("dummy", t.getName());
        assertEquals("100.0", t.getString());
        assertEquals(ZiggyDataType.ZIGGY_DOUBLE, t.getDataType());
        assertEquals(double[].class, t.getType());
    ...
    public void testInvalidConstruction() {
        new Parameter("dummy", "text", "dOuBlE");
    }

    @Test(expected = IllegalStateException.class)
    public void testIllegalScalarArrayMismatch() {
        new Parameter("dummy", "100, 200", "int");
    }

    @Test
    public void testLegalScalarArrayMismatch() {
        Parameter t = new Parameter("dummy", "100", "intarray");
    ...
    public void testGetTypedValue() {
        ...
        t = new Parameter("dummy", "100, 200, 300", "doubleArRaY");
        v = t.getValueAsArray();
        assertTrue(v instanceof double[]);
        vv = (double[]) v;
        ...
        // String array
        t = new Parameter("dummy", "100, 200, 300", "stringARRAY");
        v = t.getValueAsArray();
        ...
        t = new Parameter("dummy", " , , ", "doublearray");
        v = t.getValueAsArray();
        assertTrue(v instanceof double[]);
        vv = (double[]) v;
