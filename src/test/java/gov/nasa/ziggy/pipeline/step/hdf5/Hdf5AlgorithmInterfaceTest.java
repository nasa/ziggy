...
/**
 * Unit test class for the {@link Hdf5AlgorithmInterface} class.
 *
 * @author PT
 */
public class Hdf5AlgorithmInterfaceTest {

    public long fileId;
    public Hdf5AlgorithmInterface algorithmInterface = new Hdf5AlgorithmInterface();
    ...
    public void testWriteAndReadFile() throws HDF5LibraryException, IOException {
        ...
        algorithmInterface.writeFile(hdf5File, persistableTest2, false);
        PersistableSample2 recoveredTestValues = new PersistableSample2();
        recoveredTestValues.ignoreThisField = 0;
        boolean missingFieldsDetected = algorithmInterface.readFile(hdf5File, recoveredTestValues,
            true);
        ...
        algorithmInterface.writeFile(hdf5File, persistableTest2, true);
        recoveredTestValues = new PersistableSample2();
        recoveredTestValues.ignoreThisField = 0;
        missingFieldsDetected = algorithmInterface.readFile(hdf5File, recoveredTestValues, true);
    ...
    public void testErrorOnFileWithMissingField() throws IOException {
        ...
        PersistableSample2 recoveredTestValues = new PersistableSample2();
        recoveredTestValues.ignoreThisField = 0;
        algorithmInterface.readFile(hdf5File, recoveredTestValues, false);
    }
}
