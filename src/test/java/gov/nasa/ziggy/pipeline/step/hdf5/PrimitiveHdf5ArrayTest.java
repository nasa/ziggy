...
import static gov.nasa.ziggy.pipeline.step.hdf5.Hdf5AlgorithmInterface.BOOLEAN_ARRAY_ATT_NAME;
import static gov.nasa.ziggy.pipeline.step.hdf5.Hdf5AlgorithmInterface.EMPTY_FIELD_ATT_NAME;
import static gov.nasa.ziggy.pipeline.step.hdf5.Hdf5AlgorithmInterface.FIELD_DATA_TYPE_ATT_NAME;
import static gov.nasa.ziggy.pipeline.step.hdf5.Hdf5AlgorithmInterface.OBJECT_ARRAY_ATT_NAME;
import static gov.nasa.ziggy.pipeline.step.hdf5.Hdf5AlgorithmInterface.OBJECT_ARRAY_DIMS_ATT_NAME;
import static gov.nasa.ziggy.pipeline.step.hdf5.Hdf5AlgorithmInterface.STRING_ARRAY_ATT_NAME;
...
public class PrimitiveHdf5ArrayTest {
    ...
    public void testWriteAndReadNumericArray()
        ...
        Hdf5AlgorithmInterface.writeDataTypeAttribute(fieldGroupId, ZIGGY_INT, fieldName);
        ...
        // assertEquals(HDF5_INT, Hdf5AlgorithmInterface.readDataTypeAttribute(fieldGroupId,
        // stringTestField));
        H5.H5Gclose(fieldGroupId);

        // now read using the algorithm interface code
    ...
    public void testWriteAndReadBooleanArray()
        ...
        // execute the method
        Hdf5AlgorithmInterface.writeDataTypeAttribute(fieldGroupId, ZIGGY_BYTE, fieldName);
        ...
        assertEquals(ZIGGY_BYTE,
            Hdf5AlgorithmInterface.readDataTypeAttribute(fieldGroupId, stringTestField));
        H5.H5Gclose(fieldGroupId);
    ...
    public void testWriteAndReadStringArray()
        ...
        // create a parent group for the array
        long fieldGroupId = H5.H5Gcreate(fileId, fieldName, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
        Hdf5AlgorithmInterface.writeDataTypeAttribute(fieldGroupId, ZIGGY_STRING, fieldName);
    ...
    public void testReadScalarField()
        ...
        long fieldGroupId = H5.H5Gcreate(fileId, "doubleScalar", H5P_DEFAULT, H5P_DEFAULT,
            H5P_DEFAULT);
        Hdf5AlgorithmInterface.writeDataTypeAttribute(fieldGroupId, ZIGGY_DOUBLE, "doubleScalar");
    ...
    public void testReadListField()
        ...
        Hdf5AlgorithmInterface.writeDataTypeAttribute(fieldGroupId, ZIGGY_INT, "intList");
    ...
    public void testHyperslabIteratorConstructors() throws NoSuchFieldException, SecurityException,
        ...
        assertEquals(Hdf5AlgorithmInterface.MAX_BYTES_PER_HYPERSLAB / 4,
