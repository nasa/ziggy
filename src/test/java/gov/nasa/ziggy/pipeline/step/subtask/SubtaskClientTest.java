...
import gov.nasa.ziggy.pipeline.step.subtask.SubtaskServer.Request;
import gov.nasa.ziggy.pipeline.step.subtask.SubtaskServer.RequestType;
import gov.nasa.ziggy.pipeline.step.subtask.SubtaskServer.Response;
        ...
        try {
            ...
            for (StackTraceElement element : stackTrace) {
                if (element.getClassName()
                    .equals("gov.nasa.ziggy.pipeline.step.subtask.SubtaskClient")
