 ...
 * <li>The {@link ModelContentClass} interface, which returns the class of objects managed by the
 * table model (i.e., the actual value of parameter T).
 * </ol>
 *
 * @author PT
...
public abstract class AbstractZiggyTableModel<T> extends AbstractTableModel
    implements ModelContentClass<T> {
