 ...
 * provide the impedance match between the Java-side representation of algorithm interfaces (in the
...
public abstract class AbstractHdf5Array {
    ...
    static AbstractHdf5Array getFieldInstance(Field field) {
        ...
        if (field.getType().equals(AlgorithmParameters.class)) {
            returnObject = new AlgorithmParametersHdf5Array(field);
    ...
    static AbstractHdf5Array getObjectInstance(Object object) {
        ...
        // Special handling for AlgorithmParameters scalar instances.
        if (object.getClass().equals(AlgorithmParameters.class)) {
            returnObject = new AlgorithmParametersHdf5Array(object);
        } else if (hdf5Type.equals(ZIGGY_PERSISTABLE)) {
    ...
    protected void writeFieldOrderAttribute(long groupId, int fieldOrder) {
        ...
        long orderAttributeId = H5.H5Acreate(groupId, Hdf5AlgorithmInterface.FIELD_ORDER_ATT_NAME,
