...
import gov.nasa.ziggy.pipeline.step.subtask.SubtaskExecutor;
...
public class PipelineMetrics {
    ...
    static final String[] REMOTE_METRICS = { CREATE_INPUTS_METRIC, SEND_METRIC,
        ...
        TaskExecutor.PIPELINE_NODE_COMMIT_METRIC, TF_INPUTS_SIZE_METRIC, TF_PFE_OUTPUTS_SIZE_METRIC,
    ...
    static final String[] LOCAL_METRICS = { CREATE_INPUTS_METRIC,
        ...
        TaskExecutor.PIPELINE_NODE_COMMIT_METRIC, TF_ARCHIVE_SIZE_METRIC };
}
