...
public class PersistableHdf5Array extends AbstractHdf5Array {
    ...
    void detectPrimitiveScalarFields() {
        allFieldsPrimitiveScalar = Hdf5AlgorithmInterface
        ...
        for (Field field : fields) {
            ...
            if (isEmptyHdf5Array(persistableField)) {
                ...
                long orderAttributeId = H5.H5Acreate(fieldGroupId,
                    Hdf5AlgorithmInterface.EMPTY_FIELD_ATT_NAME, ZIGGY_BYTE.getHdf5Type(),
            ...
            Hdf5AlgorithmInterface.writeDataTypeAttribute(fieldGroupId,
    ...
    public void setParameterClassNameAttribute(long groupId, Class<?> clazz) {
        writeStringAttribute(groupId, Hdf5AlgorithmInterface.PARAMETER_CLASS_NAME_ATT_NAME,
            clazz.getName());
    }
    ...
    public List<Long> write(long fieldGroupId, String fieldName) {
        ...
        if (isScalar()) {
            ...
            long parallelArrayAttribute = H5.H5Acreate(fieldGroupId,
                Hdf5AlgorithmInterface.PARALLEL_ARRAY_ATT_NAME, ZIGGY_BYTE.getHdf5Type(),
            ...
            for (PrimitiveHdf5Array primitiveArray : parallelArrays) {
                ...
                iField++;
                Hdf5AlgorithmInterface.writeDataTypeAttribute(subGroupId,
            ...
            long objectArrayAttribute = H5.H5Acreate(fieldGroupId,
                Hdf5AlgorithmInterface.OBJECT_ARRAY_ATT_NAME, ZIGGY_BYTE.getHdf5Type(), scalarSpace,
            ...
            long objectArrayDimsAttribute = H5.H5Acreate(fieldGroupId,
                Hdf5AlgorithmInterface.OBJECT_ARRAY_DIMS_ATT_NAME, ZIGGY_LONG.getHdf5Type(),
    ...
    List<Long> writePersistableArray(long fieldGroupId, String fieldName) {
        ...
        while (arrayLocation != null) {
            ...
            String newFieldName = Hdf5AlgorithmInterface.getFieldName(fieldName, arrayLocation);
    ...
    void readPersistableScalarObject(long fileId) {
        ...
        for (Field field : fields) {
            ...
            long fieldGroupId = openGroupIfPresent(fileId, field.getName());
            if (fieldGroupId == -1) {
                continue;
            }
    ...
    public void read(long fieldGroupId) {
        ...
        if (H5.H5Aexists(fieldGroupId, Hdf5AlgorithmInterface.EMPTY_FIELD_ATT_NAME)) {
            return;
        }
        hasArrayDimsAttribute = H5.H5Aexists(fieldGroupId,
            Hdf5AlgorithmInterface.OBJECT_ARRAY_DIMS_ATT_NAME);
        ...
        if (H5.H5Aexists(fieldGroupId, Hdf5AlgorithmInterface.PARAMETER_CLASS_NAME_ATT_NAME)) {
        ...
        if (areAllFieldsPrimitiveScalar()
            && H5.H5Aexists(fieldGroupId, Hdf5AlgorithmInterface.PARALLEL_ARRAY_ATT_NAME)) {
            ...
            long attributeId = H5.H5Aopen(fieldGroupId,
                Hdf5AlgorithmInterface.OBJECT_ARRAY_DIMS_ATT_NAME, H5P_DEFAULT);
            ...
            while (location != null) {
                String arrayFieldName = Hdf5AlgorithmInterface.getFieldName(fieldName, location);
                long subGroupId = openGroupIfPresent(fieldGroupId, arrayFieldName);
                Object newObject = null;
                if (H5.H5Aexists(subGroupId,
                    Hdf5AlgorithmInterface.PARAMETER_CLASS_NAME_ATT_NAME)) {
    ...
    String getParameterClassNameFromAttribute(long fieldGroupId) {
        return readStringAttribute(fieldGroupId,
            Hdf5AlgorithmInterface.PARAMETER_CLASS_NAME_ATT_NAME);
    }
