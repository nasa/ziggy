 ...
 * memory (as specified in the {@link PipelineStep}) and call this class again to release the memory
 * once the task is complete. If insufficient memory is available, the acquire() method will block
 * until the memory becomes available.
 *
 * @author Todd Klaus
 */
