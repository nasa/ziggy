 ...
 * @author PT
 */
public class AlgorithmPipelineStepExecutor extends PipelineStepExecutor {
    ...
    public AlgorithmPipelineStepExecutor(PipelineTask pipelineTask, RunMode runMode) {
    ...
    // package-private so that non-test instances of AlgorithmPipelineStepExecutor
    ...
    public String getPipelineStepName() {
        return pipelineTask().getPipelineStepName();
    }

    PipelineStep pipelineStep() {
        return pipelineTaskOperations().pipelineStep(pipelineTask());
    }

    PipelineInputs pipelineInputs() {
        if (pipelineInputs == null) {
            pipelineInputs = PipelineInputsOutputsUtils.newPipelineInputs(
                pipelineStep().getInputsClass(), pipelineTask(), taskDirManager().taskDir());
        }
    ...
    PipelineOutputs pipelineOutputs() {
        if (pipelineOutputs == null) {
            pipelineOutputs = PipelineInputsOutputsUtils.newPipelineOutputs(
                pipelineStep().getOutputsClass(), pipelineTask(), taskDirManager().taskDir());
        }
