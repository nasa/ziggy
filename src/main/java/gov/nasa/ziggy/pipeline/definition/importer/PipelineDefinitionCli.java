...
public class PipelineDefinitionCli {
    ...
    public void go() {
        ...
        if (importLib) {
            ...
            PipelineDefinitionImporter importer = new PipelineDefinitionImporter(files);
            ...
            for (String filename : filenames) {
                List<Pipeline> pipelines = pipelineOperations().pipelines(true);
                List<ParameterSet> parameterSets = parametersOperations().parameterSets();
                new PipelineDefinitionExporter().exportPipelineConfiguration(pipelines,
                    parameterSets, filename);
            }
        }
    }
