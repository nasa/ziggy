...
/**
 * Parameters for copying task files from the task data directory to another directory, typically a
 * shared volume. These parameters are used by {@link TaskFileCopy}
 *
 * @author Todd Klaus
 */
public class TaskFileCopyParameters extends Parameters {
