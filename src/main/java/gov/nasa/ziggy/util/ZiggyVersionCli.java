...
public class ZiggyVersionCli {

    public static void main(String[] args) {
        System.out.println("   Version: " + ZiggyVersion.getSoftwareVersion());
        System.out.println("    Branch: " + ZiggyVersion.getBranch());
        System.out.println("  Revision: " + ZiggyVersion.getRevision());
        System.out.println("Build Date: " + ZiggyVersion.getBuildDate());

        if (ZiggyVersion.isRelease()) {
            System.out.println("This is a release build.");
        } else {
            System.out.println("This is not a release build.");
        }
    }
