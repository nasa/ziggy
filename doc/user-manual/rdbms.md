...
This amounts to manually importing into the database the XML files that define the pipeline, parameters, and data types. The command you will want is `ziggy import-pipelines`.
