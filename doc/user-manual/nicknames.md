...
You can add your own nicknames to your own property file that is referred to by `ZIGGY_CONFIG_FILE`. You can find examples of the format in `ziggy.properties`, which is this:
