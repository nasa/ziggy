...
4. [Pipeline Architecture](pipeline-architecture.md)

5. [Downloading and Building Ziggy](downloading-and-building-ziggy.md)

6. [Configuring a Pipeline](configuring-pipeline.md)

    6.1. [Pipeline Algorithms](pipeline-algorithms.md)

    6.2. [Python Pipeline Algorithms](python-pipeline-algorithms.md)

    6.3. [Other Pipeline Algorithms](other-pipeline-algorithms.md)

    6.5. [Algorithm Parameters](algorithm-parameters.md)

    6.4. [The Datastore](datastore.md)

    6.6. [Remote Environments](remote-environments.md)

    6.7. [Pipelines and Nodes](pipelines-and-nodes.md)

7. [Build System for your Pipeline](building-pipeline.md)
...
9. [Using the Ziggy Console, Part 1](ziggy-gui.md)
    ...
    9.4.​ [Changing Algorithm Parameter Values](change-param-values.md)

    9.5.​ [Organizing Pipelines and Parameter Sets](organizing-tables.md)

    9.6. [The Edit Pipeline Dialog Box](edit-pipeline.md)

    9.7. [The Datastore Control Panel](datastore-regexp.md)

10. [Intermediate Topics](intermediate-topics.md)

    10.1. [The Datastore and the Task Directory](datastore-task-dir.md)

    10.2. [Setting up a Relational Database Management System (RDBMS)](rdbms.md)
